...
class ColocalizationAnalysis implements DialogListener {
...
channelPairsArray = ["C1 + C2", "C1 + C3", "C1 + C4", "C2 + C3", "C2 + C4", "C3 + C4"]
defaultCheckboxArray = [false, false, false, false, false, false]
...
zProjectOptionsArray = ["None", "(A) Use Z Projection + View Original Image as Z-STACK", "(B) Use Z Projection + View Original Image as Z-PROJECTION"]
...
def C1lowerthresh = Dialog.getNumber()
def C1upperthresh = Dialog.getNumber()
def C2lowerthresh = Dialog.getNumber()
def C2upperthresh = Dialog.getNumber()
def C3lowerthresh = Dialog.getNumber()
def C3upperthresh = Dialog.getNumber()
def C4lowerthresh = Dialog.getNumber()
def C4upperthresh = Dialog.getNumber()

/* Other variables */
def c1Name = Dialog.getString()
def c2Name = Dialog.getString()
def c3Name = Dialog.getString()
def c4Name = Dialog.getString()

def c1c2 = Dialog.getCheckbox()
def c1c3 = Dialog.getCheckbox()
def c1c4 = Dialog.getCheckbox()
def c2c3 = Dialog.getCheckbox()
def c2c4 = Dialog.getCheckbox()
def c3c4 = Dialog.getCheckbox()

def zProjectOption = Dialog.getRadioButton() //Z Projection Options selection
...
def c1minParticleSize = Dialog.getNumber()
def c2minParticleSize = Dialog.getNumber()
def c3minParticleSize = Dialog.getNumber()
def c4minParticleSize = Dialog.getNumber()
def c1maxParticleSize = Dialog.getNumber()
def c2maxParticleSize = Dialog.getNumber()
def c3maxParticleSize = Dialog.getNumber()
def c4maxParticleSize = Dialog.getNumber()

def c1c2min = Dialog.getNumber()
def	c1c3min = Dialog.getNumber();
def	c1c4min = Dialog.getNumber();
def	c2c3min = Dialog.getNumber();
def	c2c4min = Dialog.getNumber();
def	c3c4min = Dialog.getNumber();
def	c1c2max = Dialog.getNumber();
def	c1c3max = Dialog.getNumber();
def	c1c4max = Dialog.getNumber();
def	c2c3max = Dialog.getNumber();
def	c2c4max = Dialog.getNumber();
def	c3c4max = Dialog.getNumber();
